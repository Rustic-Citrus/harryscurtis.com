      ...
      <div class="hero-content flex grow flex-col lg:flex-row justify-center gap-4 *:m-5 *:flex *:flex-col *:gap-2">
        <div class="flex justify-center lg:max-w-1/2">
          ...
          <div class="collapse collapse-plus bg-base-100 border border-base-300 mt-2">
            <input type="radio" name="homepage-accordion" checked="checked" />
            <div class="collapse-title font-semibold">
              Where do you provide services?
            </div>
            <div class="collapse-content text-sm">
              Based out of Hay-on-Wye, I can provide face-to-face services to
              clients in Powys, Herefordshire and Monmouthshire. For
              consultation services, I can also provide advice over the phone or
              video call.
            </div>
          </div>
          <div class="collapse collapse-plus bg-base-100 border border-base-300">
            ...
            <div class="collapse-content">
              <p class="text-sm mb-4">
                To arrange a consultation or to enquire about my services,
                please contact me using the contact form, accessible through the
                button below.
              </p>
              <a
                href="/contact"
