...
export default define.page(() => {
  return (
    <div class="flex flex-col min-h-screen py-12 lg:py-24 gap-32">
      <div class="flex flex-col md:flex-row items-center gap-6 px-6 lg:px-24">
        <img
        ...
        />
        <div class="flex flex-col grow justify-center text-center md:text-left">
      ...
      <div class="flex flex-col md:flex-row-reverse items-center gap-6 px-6 lg:px-24">
        <img
        ...
        />
        <div class="flex flex-col grow justify-center text-center md:text-right">
